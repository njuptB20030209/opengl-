...
#pragma region Init_Shader_Program
    Shader myShader("seniorOpenGL.vert", "seniorOpenGL.frag");
    Shader stencilShader("seniorOpenGL.vert", "stencil.frag");
    Shader grassShader("seniorOpenGL.vert", "grass.frag");
...
#pragma region Init Material and Lights
    ...
    for (unsigned int i = 0; i < vegetations.size(); i++)
    {
        ...
        glm::vec3 offposition = glm::vec3(vegetations[i].x, vegetations[i].y, vegetations[i].z + 0.3);
        sorted[distance] = offposition;
    }
...
#pragma region grass
       ...
       {
           model = glm::mat4(1.0f);
           model = glm::translate(model, vegetations[i]);
